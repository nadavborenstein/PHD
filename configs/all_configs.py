...
class RenderingArguments:
    ...
    font_dir: str = field(
        default="/home/knf792/PycharmProjects/pixel/dataset_synthesis/synthetic_text_gen/all_fonts/",
        metadata={"help": "Path to the fonts directory."},
    )
    font_list_path: str = field(
        default="antique_fonts.csv", metadata={"help": "Path to the fonts list."}
    )
    ...
    noise_probability: float = field(
        default=0.8, metadata={"help": "probability of applying pixel level noise"}
    )
...
class VisualizationArguments:
    ...
    """
    vis_model_path: str = "/Users/knf792/cluster/PycharmProjects/pixel/experiments/2174468/outputs"
    auth_token: str = ""
    revision: str = "main"
